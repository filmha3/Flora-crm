    ...
    <BodyPortal>
      <div className="fixed inset-0 z-[95] flex flex-col flora-focus-in" style={{ background: c.bg }}>
        ...
        <div className="flex shrink-0" style={{ gap: SP.sm, padding: SP.lg, paddingBottom: `calc(${SP.lg}px + env(safe-area-inset-bottom, 0px))` }}>
          ...
          <button onClick={goNext} className="press flex-1 flex items-center justify-center" style={{ gap: SP.xs, paddingBlock: SP.md, borderRadius: RAD.lg, background: "linear-gradient(135deg,#0F5132,#C5A880)", color: "#fff", fontWeight: FW.bold, fontSize: FS.body + 1, boxShadow: "0 12px 28px -10px rgba(47,124,246,0.5)" }}>
    ...
    <BodyPortal>
      <div className="fixed inset-0 z-[95] flex flex-col flora-focus-in" style={{ background: c.bg }}>
        ...
        <div className="shrink-0" style={{ padding: SP.lg, paddingBottom: `calc(${SP.lg}px + env(safe-area-inset-bottom, 0px))` }}>
          <button onClick={finish} className="press w-full flex items-center justify-center" style={{ gap: SP.xs, paddingBlock: SP.md, borderRadius: RAD.lg, background: "linear-gradient(135deg,#0F5132,#C5A880)", color: "#fff", fontWeight: FW.bold, fontSize: FS.body + 1, boxShadow: "0 12px 28px -10px rgba(47,124,246,0.5)" }}>
